...
public class JugadorController implements Serializable {
    ...
    @EJB
    private co.sena.edu.facade.JugadorFacade ejbFacade;
    ...
    public Jugador getJugador(java.lang.Long id) {
